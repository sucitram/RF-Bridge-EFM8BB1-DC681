...
/*
 * Arlec DC861 Plug In Wireless Door Chime
 */
#if EFM8BB1_SUPPORT_DC861_PROTOCOL == 1
#define DC861
// AA B0 15 03 08 017C 026C 13CE 28180918180918181809091818 55
SI_SEGMENT_VARIABLE(PROTOCOL_BUCKETS(DC861)[], static uint16_t, SI_SEG_CODE) = { 360, 650, 5080 };
SI_SEGMENT_VARIABLE(PROTOCOL_START(DC861)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(3)  };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT0(DC861)[], static uint8_t, SI_SEG_CODE) = { HIGH(0), LOW(1) };
SI_SEGMENT_VARIABLE(PROTOCOL_BIT1(DC861)[], static uint8_t, SI_SEG_CODE) = {  HIGH(1), LOW(0) };
#endif
...
#if EFM8BB1_SUPPORT_DC861_PROTOCOL == 1
		{
			{ &PROTOCOL_BUCKETS(DC861), ARRAY_LENGTH(PROTOCOL_BUCKETS(DC861)) },
			{ &PROTOCOL_START(DC861), ARRAY_LENGTH(PROTOCOL_START(DC861)) },
			{ &PROTOCOL_BIT0(DC861), ARRAY_LENGTH(PROTOCOL_BIT0(DC861)) },
			{ &PROTOCOL_BIT1(DC861), ARRAY_LENGTH(PROTOCOL_BIT1(DC861)) },
			{ NULL, 0 },
			12
		},
#endif
